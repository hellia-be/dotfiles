...
-- Basic UI elements
vim.cmd('highlight Normal guibg=#262626 guifg=#d9d9d9')
vim.cmd('highlight NonText guibg=#262626 guifg=#262626')
...
vim.cmd('highlight CurSearch guibg=#a6a6a6 guifg=#262626')
vim.cmd('highlight IncSearch gui=None guibg=#a6a6a6 guifg=#262626')
